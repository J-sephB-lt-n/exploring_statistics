...
* Regression Modelling
    * Linear model (OLS,GLS), GLM (Poisson regression), splines, ridge/lasso/elastic net, KNN, regression tree, GBM, bagging & random forest, feed-forward neural network
...
* Other hobbies that I come to terms with only having time for again only after I retire: juggling, making computer games, drawing, unicycling, writing