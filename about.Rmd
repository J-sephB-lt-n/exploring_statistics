...
* SQL
    * Vertica, PostgreSQL
    * window functions: rank, dense_rank, first_value, row_number, median, ntile, 
    * writing txt, csv -> SQL
...
* Regression Modelling
    * Linear model, GLM (Poisson regression), splines, elastic net, KNN, regression tree, GBM, bagging & random forest, feed-forward neural network
